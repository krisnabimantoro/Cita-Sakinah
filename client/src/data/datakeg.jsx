...
const datakeg = [
  ...
  },
  {
    ...
    titleCard: "Prestasi Anak TPA Cita Sakinah",
    detail:
      "Anak-anak TPA Cita Sakinah meraih berbagai prestasi dalam lomba kreativitas anak tingkat kota. Mereka menunjukkan bakat luar biasa dalam seni, musik, dan olahraga, membawa pulang berbagai penghargaan.",
    tanggal: "5 Juli 2024",
  },
  {
    id: 4,
  ...
  },
  {
    ...
    tagUtama: "Kegiatan Siswa",
    tagSekolah: "TPA Cita Sakinah",
    titleCard: "Kegiatan Seni TPA Cita Sakinah",
    detail:
      "Anak-anak di TPA Cita Sakinah mengikuti kegiatan seni untuk mengekspresikan kreativitas mereka. Kegiatan ini termasuk melukis, menggambar, dan membuat kerajinan tangan.",
  ...
  },
  {
    ...
    tagUtama: "Prestasi",
    tagSekolah: "TPA Cita Sakinah",
    titleCard: "Prestasi Akademik",
    detail:
      "Anak-anak di TPA Cita Sakinah meraih prestasi akademik dalam berbagai mata pelajaran. Mereka menunjukkan kemajuan signifikan dalam membaca, menulis, dan matematika.",
